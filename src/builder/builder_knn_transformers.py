...
class ModeloKNN_Transformers:
    ...
    def plotar_matriz_confusao_geral(self, X_test: np.ndarray, y_test: list[str]) -> None:
        '''
        Gera e plota a Matriz de Confusão geral (12x12) como um Heatmap.

        :param X_test: Array NumPy contendo os vetores de teste.
        :param y_test: Lista contendo os rótulos reais dos dados de teste.
        ...
        plt.title('Matriz de Confusão Geral (12x12) - KNN', fontsize=18, pad=20)
